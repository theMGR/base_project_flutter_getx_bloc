...
class CustomPrettyDioLogger extends Interceptor {
  ...
  void onRequest(RequestOptions options, RequestInterceptorHandler handler) {
    ...
    if (requestBody && options.method != 'GET') {
      if (isPrintRawJSON) {
        _printAll(message: jsonEncode(options.data), title: "Request Body");
      } else {
  ...
  void onResponse(Response response, ResponseInterceptorHandler handler) {
    ...
    if (responseBody) {
      if (isPrintRawJSON) {
        _printAll(message: response.toString(), title: "Response Body");
      } else {
        logPrint('╔ Body');
        logPrint('║');
  ...
  void _printAll({required String message, String title = ""}) {
